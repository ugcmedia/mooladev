...
<div class="page-content row">
	...
	{!! Form::open(array('url'=>'vendoroutlets?return='.$return, 'class'=>'form-horizontal validated','files' => true )) !!}
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("vendoroutlets/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
