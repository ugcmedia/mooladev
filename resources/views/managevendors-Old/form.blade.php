...
<div class="col-md-12">
				...
				{!! Form::hidden('vendor_id', $row['vendor_id']) !!}
									  <div class="form-group depen- wrap-vendor_code  " >
										...
										<div class="col-md-6">
										  <input  type='number' name='vendor_code' id='vendor_code' value='{{ $row['vendor_code'] }}'
						     class='form-control is_number'  />
									  ...
									  <div class="form-group depen- wrap-email  " >
										<label for="Vendor Email" class=" control-label col-md-4 text-left"> Vendor Email </label>
