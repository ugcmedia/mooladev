...
$(document).ready(function(){
	...
	function responeFormType(val)
	{
		...
		if(val =='select' || val =='radio' || val =='checkbox') {
			...
			$('.database').hide();$('.datalist').show();$('.file-upl').hide(); $('.imageMedia').hide();
...
<div class="form-horizontal row">
  ...
  <div class="form-group standart-form database" style="display:none;">
	...
	<div class="col-md-8">
		...
		<label class="checkbox">				
		<input name="lookup_where_clause" type="text" class="ext form-control" id="lookup_key" style=" border-bottom: solid 1px #ddd;"  
