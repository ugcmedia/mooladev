<div class="col-lg-3 col-md-4 p-2  store-info">
  ...
  <div class="cat-main-image div-inner-white rounded text-center p-3 mb-4">
    <div class="p-21">
      ...
      @if(Auth::guard('member')->check())
        <a href="#0" onclick="addSubscriber({{$data['cat']->cat_id}},'cat','{{route('add.subscribe')}}','common-subscription-msg')">
    ...
    <div class="cat-main-img m-3"  >
      @php
       $catImg = ($data['cat']->cat_icon != '')? asset('uploads/images/category').'/'.$data['cat']->cat_icon : asset('uploads/images/no-image.jpg');
      @endphp
      <img class="img-fluid" src="{{$catImg}}" alt="">
    </div>
 </div>
 @if(!$mobileDetection->isMobile())
  <div class="sidebarBox">
    <div class="" id="stickFilter">
    ...
    @php
        $Widget = AppClass::getWidget('category');
    @endphp
...
<style>
  .cat-ht-icon:hover .s-favorite-ico {
    opacity: 1
  }
</style>
