    ...
    <div class="container">
      ...
      <div class="page-navigation">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb p-0 mb-2">
            ...
            <li class="breadcrumb-item"><a href="#">{{__('public/category.category') }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{$data['cat']->cat_name}}</li>
          </ol>
        </nav>
      </div>
      ...
      <div class="hero-banner-cont ">
        <div class="row">
          <div class="col-md-12">
            <div class="st-title">
               <h1 class="font-48"><span class="fw-700 text-white">{{$data['cat']->cat_name}}</span></h1>
               <div class="text-white">
                   <p class="text-white font-14 fw-400 "> {!!$data['cat']->cat_desc!!}</p>
                </div>
                ...
                <div class="tab-pane fade active show" id="pills-cat" role="tabpanel" aria-labelledby="pills-cat-tab">
                  <div class="cat-filter pt-3">
                    <div class="filter-title mb-3 position-relative">
                      ...
                      <span class="icon-Search-grey-icon side-search"></span>
                      <input type="text" id="searchCat" name="" value="" class="sidebar-main-search form-control border-0 bg-promo1 mb-2" placeholder="Search filters">
                    </div>
