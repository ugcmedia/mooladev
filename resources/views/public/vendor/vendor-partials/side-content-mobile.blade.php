  ...
  <div class="offers-filters-sidebar p-3 mb-4 div-inner-white rounded">
                ...
                @php if($i == 3 ) break; @endphp
                 <li class="mb-3">
                   <div class="offers-list-items">
                     ...
                     <p class="secondary-text font-15 fw-400 mb-0">  {{trim($cashStru->cb_desc)}}</p>
                   </div>
                 </li>
                 @php $i++; @endphp
               @endforeach
  ...
  @foreach($Widget as $key=>$getStoreWidget)
     ...
     <div class="similer-stores-filters-sidebar p-3 mb-4 div-inner-white rounded ">
