<div class="col-lg-3 col-md-4 store-info">
  ...
  <div class="cat-main-image div-inner-white rounded text-center p-3 mb-4">
    <div class="p-21">
      ...
      @if(Auth::guard('member')->check())
        <a href="#0" onclick="addSubscriber({{$data['brand']->brand_id}},'brand','{{route('add.subscribe')}}','common-subscription-msg')">
    ...
    <div class="cat-main-img m-3"  >
      @php
        $brandImg = ($data['brand']->brand_icon != '')? asset('uploads/images/brand').'/'.$data['brand']->brand_icon : asset('uploads/images/no-image.jpg');
      @endphp
      <img class="img-fluid" src="{{$brandImg}}" alt="">
    </div>
  </div>
  ...
  <div class="sidebarBox">
    ...
    @php
        $Widget = AppClass::getWidget('brand');
    @endphp
