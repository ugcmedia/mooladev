 ...
 <div class="table-responsive">
		...
		<thead class="no-border">
          <tr >
			...
			<th scope="col" data-hide="phone">Note</th>
			<th scope="col" data-hide="phone">Dependency</th>
            <th scope="col">&nbsp;</th>
          </tr>
		  </thead>
		  ...
		  <?php $i=0; foreach($forms as $rows){
			 if( ! isset($rows['note']) )  $rows['note'] = '';
			 if( ! isset($rows['dependency']) )  $rows['dependency'] = '';
		  $id = ++$i;
		  ?>
          <tr>
		...
		<td>
				<input type="text" name="note[<?php echo $id;?>]" class="form-control input-sm" value="{{ $rows['note'] }}" />
				
		</td>
        <td>
				<input type="text" name="dependency[<?php echo $id;?>]" class="form-control input-sm" value="{{ $rows['dependency'] }}" />
			...
			<?php if(!isset($rows['option']['lookup_where_clause'])) $rows['option']['lookup_where_clause'] = '';?>
			...
			<input type="hidden" name="lookup_where_clause[<?php echo $id;?>]" value="<?php echo $rows['option']['lookup_where_clause'];?>" />
