...
$(document).ready(function(){
	...
	function responeFormType(val)
	{
		if(val =='select' || val =='radio' || val =='checkbox') {
			...
			$('.standart-form').show(); $('.file-upl').hide(); $('.imageMedia').hide();
			...
			$('.standart-form').hide(); 
			$('.database').hide();$('.datalist').hide();$('.file-upl').hide();$('.imageMedia').hide();
		}
...
<div class="" style="padding:30px;">			
  ...
  <div class="form-group standart-form database" style="display:none;">
	...
	<div class="col-md-8">
		...
		<?php if(!isset($f['option']['lookup_where_clause'])) $f['option']['lookup_where_clause'] = '';?>
		<label class="col-md-12">
		...
		<label class="col-md-12">				
		<input name="lookup_where_clause" type="text" class="ext form-control input-sm" id="lookup_key" style=" border-bottom: solid 1px #ddd;"  
		value="<?php echo $f['option']['lookup_where_clause'];?>"	placeholder='Where Clause' />
		</label>		
		<label class="col-md-12" >
  ...
  <div class="form-group standart-form imageMedia"  style="display:none;">
    <label for="ipt" class=" control-label col-md-4"> Upload Path </code></label>
	<div class="col-md-8">
		<input name="path_to_upload" type="text" id="path_to_upload" class="form-control input-sm" value="<?php echo $f['option']['path_to_upload'];?>"/>
	 </div> 
  </div>   
