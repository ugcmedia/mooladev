...
trait HasAuthor
{
    ...
    */
    ...
    {
        return $this->belongsTo(static::$userModel, 'member_id', static::$userKey);
    }
    ...
    {
        return $this->userAttribute('first_name', $value);
    }
    ...
    {
        return $this->userAttribute('url', null);
    }
