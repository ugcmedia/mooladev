...
class StoreComment extends FormRequest
{
    ...
    /**
     * Add missing rules to the validator.
     *
     * @return void
     */
    protected function addMissingRules()
    {
        if (version_compare(app()->version(), '5.3.0') < 0) {
            Validator::extend('nullable', function () { return true; });
        }
    }
}
