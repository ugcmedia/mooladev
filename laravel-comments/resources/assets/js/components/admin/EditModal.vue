      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="save" @keydown="form.errors.clear($event.target.name)">
          <div class="modal-body">
            ...
            <!-- Author Name -->
            <div class="form-group" :class="{ 'has-danger': form.errors.has('author_name') }">
            ...
            <!-- Author Email -->
            <div class="form-group" :class="{ 'has-danger': form.errors.has('author_email') }">
            ...
            <!-- Author Url -->
            <div class="form-group" :class="{ 'has-danger': form.errors.has('author_url') }">
            ...
            <div class="form-group">
              ...
              <select v-model="form.status" id="comment_status" name="status" class="form-control custom-select">
                <option v-for="status in ['pending', 'approved', 'spam', 'trash']" :value="status">
                  {{ $t(`status_${status}`) }}
                </option>
              </select>
            ...
            <!-- Comment Content -->
            <div class="form-group mb-0 clearfix" :class="{ 'has-danger': form.errors.has('content') }">
