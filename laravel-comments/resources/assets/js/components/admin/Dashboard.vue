    ...
    <div class="card-block">
      <h4 class="card-title mb-4 pb-2">
        ...
        <a v-if="args.page_id || (args.commentable_id && args.commentable_type)"
          :href="`?status=${args.status}`" class="float-right">
      ...
      <ul class="status__filter">
        <li v-for="(status, index) in statuses" :class="{ active: status === args.status }">
      ...
      <div class="row my-2">
        ...
        <div class="col-12 col-sm-8 col-lg-10">
          <div class="bulk__actions">
            <select v-model="bulkAction" class="form-control form-control-sm custom-select">
        ...
        <div class="col-12 col-sm-4 col-lg-2">
          <select v-model="order" class="form-control form-control-sm custom-select">
          ...
          <thead>
            <tr>
              <th class="column__checkbox">
                <input type="checkbox" @click="toggleCheckbox" ref="toggleall">
              </th>
...
export default {
  components: {
    ...
    'edit-modal': require('./EditModal.vue')
  },
