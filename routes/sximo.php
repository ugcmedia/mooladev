...
Route::get('sximo/config/developer','ConfigController@getDev');
Route::get('sximo/config/email','ConfigController@getEmail');
Route::get('sximo/config/security','ConfigController@getSecurity');
...
Route::post('sximo/config/developer','ConfigController@postDeveloper');
...
Route::get('sximo/menu/genicon/{any?}','MenuController@getGenIcons');
...
//-------------------------------------------------------------------------
/* Start  Menu Routes */
Route::get('sximo/fmenu/','FrontMenuController@getIndex');
Route::get('sximo/fmenu/index/{any?}','FrontMenuController@getIndex');
Route::get('sximo/fmenu/destroy/{any?}','FrontMenuController@getDestroy');
Route::get('sximo/fmenu/icon','FrontMenuController@getIcons');

Route::post('sximo/fmenu/save','FrontMenuController@postSave');
Route::post('sximo/fmenu/saveorder','FrontMenuController@postSaveorder');
/* End  Config Routes */
