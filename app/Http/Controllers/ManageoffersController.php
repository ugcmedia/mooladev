...
class ManageoffersController extends Controller {
	...
	public $module = 'manageoffers';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Manageoffers();
		...
		$this->data = array(
			...
			'pageModule'		=> 'manageoffers',
			'frontendSlug'		=> $this->info['frontend_slug'],
			'pageUrl'			=>  url('manageoffers'),
	...
	public static function display(  )
	{
		...
		$model  = new Manageoffers();
		$info = $model::makeInfo('manageoffers');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('manageoffers.public.view',$data);			
			}			
		} 
		else {
			...
			return view('manageoffers.public.index',$data);	
		}
