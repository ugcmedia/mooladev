...
class ManagebrandsController extends Controller {
	...
	public $module = 'managebrands';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Managebrands();
		...
		$this->data = array(
			...
			'pageModule'		=> 'managebrands',
			'frontendSlug'		=> $this->info['frontend_slug'],
			'pageUrl'			=>  url('managebrands'),
	...
	public static function display(  )
	{
		...
		$model  = new Managebrands();
		$info = $model::makeInfo('managebrands');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('managebrands.public.view',$data);			
			}			
		} 
		else {
			...
			return view('managebrands.public.index',$data);	
		}
