...
class LookupmasterController extends Controller {
	...
	public $module = 'lookupmaster';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Lookupmaster();
		...
		$this->data = array(
			...
			'pageModule'		=> 'lookupmaster',
			'frontendSlug'		=> $this->info['frontend_slug'],
			'pageUrl'			=>  url('lookupmaster'),
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('lookupmaster');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('lookupmaster.public.view',$data);			
			}			
		} 
		else {
			...
			return view('lookupmaster.public.index',$data);	
		}
