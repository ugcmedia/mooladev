...
class CurrencyratesController extends Controller {
	...
	public $module = 'currencyrates';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Currencyrates();	
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('currencyrates');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('currencyrates.public.view',$data);			
			}			
		} 
		else {
			...
			return view('currencyrates.public.index',$data);	
		}
