...
class ManagereviewsController extends Controller {
	...
	public $module = 'managereviews';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Managereviews();
		...
		$this->data = array(
			...
			'pageModule'		=> 'managereviews',
			'frontendSlug'		=> $this->info['frontend_slug'],
			'pageUrl'			=>  url('managereviews'),
	...
	public static function display(  )
	{
		...
		$model  = new Managereviews();
		$info = $model::makeInfo('managereviews');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('managereviews.public.view',$data);			
			}			
		} 
		else {
			...
			return view('managereviews.public.index',$data);	
		}
