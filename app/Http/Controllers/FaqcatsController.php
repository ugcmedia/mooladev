...
class FaqcatsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'faqcats';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Faqcats();	
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('faqcats.public.view',$data);			
			}			
		} 
		else {
			...
			return view('faqcats.public.index',$data);	
		}
