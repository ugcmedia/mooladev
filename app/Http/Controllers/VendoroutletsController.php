...
use App\Models\Vendoroutlets;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 

class VendoroutletsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'vendoroutlets';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Vendoroutlets();
		...
		$this->data = array(
			...
			'pageModule'		=> 'vendoroutlets',
			'frontendSlug'		=> $this->info['frontend_slug'],
			'pageUrl'			=>  url('vendoroutlets'),
	...
	public static function display(  )
	{
		...
		$model  = new Vendoroutlets();
		$info = $model::makeInfo('vendoroutlets');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('vendoroutlets.public.view',$data);			
			}			
		} 
		else {
			...
			return view('vendoroutlets.public.index',$data);	
		}
