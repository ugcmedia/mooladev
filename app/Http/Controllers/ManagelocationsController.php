...
use App\Models\Managelocations;
...
class ManagelocationsController extends Controller {
	...
	public $module = 'managelocations';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Managelocations();
		...
		$this->data = array(
			...
			'pageModule'		=> 'managelocations',
			'frontendSlug'		=> $this->info['frontend_slug'],
			'pageUrl'			=>  url('managelocations'),
	...
	public static function display(  )
	{
		...
		$model  = new Managelocations();
		$info = $model::makeInfo('managelocations');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('managelocations.public.view',$data);			
			}			
		} 
		else {
			...
			return view('managelocations.public.index',$data);	
		}
