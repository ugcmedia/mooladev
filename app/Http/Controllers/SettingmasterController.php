...
class SettingmasterController extends Controller {
	...
	public $module = 'settingmaster';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Settingmaster();
		...
		$this->data = array(
			...
			'pageModule'		=> 'settingmaster',
			'frontendSlug'		=> $this->info['frontend_slug'],
			'pageUrl'			=>  url('settingmaster'),
	...
	public static function display(  )
	{
		...
		$model  = new Settingmaster();
		$info = $model::makeInfo('settingmaster');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('settingmaster.public.view',$data);			
			}			
		} 
		else {
			...
			return view('settingmaster.public.index',$data);	
		}
