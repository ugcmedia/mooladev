...
class ManagetagsController extends Controller {
	...
	public $module = 'managetags';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Managetags();
		...
		$this->data = array(
			...
			'pageModule'		=> 'managetags',
			'frontendSlug'		=> $this->info['frontend_slug'],
			'pageUrl'			=>  url('managetags'),
	...
	public static function display(  )
	{
		...
		$model  = new Managetags();
		$info = $model::makeInfo('managetags');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('managetags.public.view',$data);			
			}			
		} 
		else {
			...
			return view('managetags.public.index',$data);	
		}
