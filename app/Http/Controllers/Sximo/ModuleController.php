...
class ModuleController extends Controller {
    ...
    function postSaveconfig( Request $request) 
    {
        ...
        if ($validator->passes()) {
            $data = array(
                'module_title'    	=> $request->input('module_title'),
                'module_note'    	=> $request->input('module_note'),
				'module_frontend_slug'		=> $request->input('module_frontend_slug'),
            );
    ...
    public function postSaveform( Request $request)
    {
        ...
        for($i=1; $i<= $total ;$i++) {
            ...
            $f[] = array(
				...
				'dependency'    => (isset($dependency[$i]) ? $dependency[$i] : ''),
                'option'        => array(
                    "opt_type"                 => $opt_type[$i],
					...
					'lookup_where_clause'    => $lookup_where_clause[$i],
    ...
    public function getEditform(Request $request, $id )
    {
            ...
            if($form['field'] == $field_id && $form['alias'] == $alias)
            {
                ...
                $f = array(
                    ...
                    'option'        => array(
						...
						'lookup_where_clause'    => isset( $form['option']['lookup_where_clause'])? $form['option']['lookup_where_clause']:'',
        ...
        $this->data['field_type_opt'] = array(
            ...
            'color'        => 'Color Picker',
            'maps'        => 'Google Maps',
			'update_timestamp' => 'Hidden CurrentTime'
   ...
   function postSaveformfield( Request $request)
    {
        ...
        $new_field = array(
            ...
            'option'        => array(
				...
				'lookup_where_clause'=>  $request->input('lookup_where_clause'),
