...
class ContactsubmitsController extends Controller {
	...
	public $module = 'contactsubmits';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Contactsubmits();
		...
		$this->data = array(
			...
			'pageModule'		=> 'contactsubmits',
			'frontendSlug'		=> $this->info['frontend_slug'],
			'pageUrl'			=>  url('contactsubmits'),
	...
	public static function display(  )
	{
		...
		$model  = new Contactsubmits();
		$info = $model::makeInfo('contactsubmits');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('contactsubmits.public.view',$data);			
			}			
		} 
		else {
			...
			return view('contactsubmits.public.index',$data);	
		}
