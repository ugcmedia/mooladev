...
use App\Models\Deltecontolr;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class DeltecontolrController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'deltecontolr';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Deltecontolr();	
	...
	public static function display(  )
	{
		...
		$model  = new Deltecontolr();
		$info = $model::makeInfo('deltecontolr');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('deltecontolr.public.view',$data);			
			}			
		} 
		else {
			...
			return view('deltecontolr.public.index',$data);	
		}
