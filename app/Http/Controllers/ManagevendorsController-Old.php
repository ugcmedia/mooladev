...
class ManagevendorsController extends Controller {
	...
	public $module = 'managevendors';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Managevendors();
		...
		$this->data = array(
			...
			'pageModule'		=> 'managevendors',
			'frontendSlug'		=> $this->info['frontend_slug'],
			'pageUrl'			=>  url('managevendors'),
	...
	public static function display(  )
	{
		...
		$model  = new Managevendors();
		$info = $model::makeInfo('managevendors');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('managevendors.public.view',$data);			
			}			
		} 
		else {
			...
			return view('managevendors.public.index',$data);	
		}
