...
class PagesController extends Controller {
	...
	function create( Request $request )
	{
		...
		$path = base_path().'/resources/views/public/'.$this->config['cnf_theme'].'/info.json';
	...
	function createRouters()
	{
		...
		foreach($rows as $row)
		{
			...
			$slug = $row->alias;
			if($row->alias!='blog')
			$val .= "Route::get('{$slug}', 'PublicController\PubPageController@index');\n";
		}
		$val .= 	"?>";
